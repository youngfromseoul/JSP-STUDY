...
<%
    ...
    try {
        String DB_HOST = "jdbc:oracle:thin:@127.0.0.1:49161:XE"; // 아이피, 포트, 서비스(SID) 정보를 수정
        String DB_USER = "system"; // 아이디(유저) - 11g 이상시 대소문자 구분 확인
        String DB_PASS = "oracle"; // 패스워 - 11g 이상시 대소문자 구분 확인
